...
<template>
  <section class="bg-white dark:bg-black text-black-800 dark:text-secondary my-12">
    <div class="mx-auto w-3/4">
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">In accessing, browsing and/or using any area of the Website, you acknowledge that you have read, understand, and
      ...
      <h2 class="text-extrabold text-3xl my-12">1. Restrictions on Use of Materials</h2>
       <h3 class="text-extrabold text-2xl my-8">a. Licensing, Eligibility, and Use of the Website</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">When you provide information to the Website, you agree to provide only true, accurate,
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Subject to compliance with these Terms, for a limited time, the Website is granting its users a
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You understand and agree that the Website is provided "as-is" and that we assume no
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You also agree that you will not (i) use any robot, spider, rover, scraper, or any other data
        ...
        written consent.</p>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">We will employ reasonable measures to protect the security of users and user information,
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You must be 18 or over, or the legal age to form a binding contract in your jurisdiction if that
       ...
       <h3 class="text-extrabold text-2xl my-8">b. Trademarks</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">The trademarks, service marks, trade names, and logos (collectively "Trademarks") used and
       ...
       <h3 class="text-extrabold text-2xl my-8">c. Copyright Notice</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You acknowledge that the Website contains information, data, software, text, photographs,
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Without limiting the generality of the foregoing, use of any software Company Content shall
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">It is our policy to (a) block access to or remove material that it believes in good faith to be
       ...
       <h3 class="text-extrabold text-2xl my-8">a. Procedure for Reporting Copyright Infringements.</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">If you believe that material or content residing on or accessible through the Website or the
      ...
      <ul class="list-disc">
       ...
       <h3 class="text-extrabold text-2xl my-8">b. Upon Receipt of a Bona Fide Infringement Notification</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Once Proper Bona Fide Infringement Notification is received by the Designated Agent, it is
        our policy:</p>
      <ul class="list-disc">
       ...
       <h3 class="text-extrabold text-2xl my-8">c. Procedure to Supply a Counter-Notice to the Designated Agent</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">If the content provider, member or user believes that the material that was removed or to
      ...
      <ul class="list-disc">
       ...
       <h3 class="text-extrabold text-2xl my-8">d. Removal</h3>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">If a counter-notice is received by the Designated Agent, we may send a copy of the counter-
       ...
       <h3 class="text-extrabold text-2xl my-8">e. Address for Designated Agent</h3>
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You acknowledge and agree that the Website and any necessary software used in connection with
        ...
        Website.</p>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Your affirmative act of using this Website and/or registering for the Website or the services
        constitutes your electronic signature to these Terms and your consent to enter into agreements with
        us electronically.</p>

      <h2 class="text-extrabold text-3xl my-12">4. Representations and Warranties</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You represent and warrant to us that you will fully comply with these Terms. If you choose to post
      ...
      <h2 class="text-extrabold text-3xl my-12">5. Indemnification</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You hereby agree to indemnify, defend and hold us, our affiliated companies, and all officers,
      ...
      <h2 class="text-extrabold text-3xl my-12">6. Termination</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">You may terminate this license at any time by ceasing to access and use the Website, although you
      ...
      <h2 class="text-extrabold text-3xl my-12">7. DISCLAIMER OF WARRANTIES, LIMITATION OF LIABILITY, AND EXCLUSIONS AND LIMITATIONS</h2>
      ...
      <h2 class="text-extrabold text-3xl my-12">8. Third-Party Content</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">The Website may provide, or third parties may provide, links to other websites or resources.
      ...
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Your correspondence or business dealings with, or participation in promotions of, advertisers found
      ...
      <h2 class="text-extrabold text-3xl my-12">11. Construction and Interpretation</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Headings in these Terms are for ease of reference only and are not to be used to interpret the terms
        and conditions hereof.</p>

      <h2 class="text-extrabold text-3xl my-12">12. Governing Law</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">These Terms shall be governed by, and construed in accordance with, the laws of Minnesota,
      ...
      <h2 class="text-extrabold text-3xl my-12">13. Jurisdiction and Venue</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">Each party hereby consents to the jurisdiction of the state and federal courts sitting in Minnesota;
      ...
      <h2 class="text-extrabold text-3xl my-12">14. Entire Agreement</h2>
      <p class="mb-4 mt-0 text-base font-light leading-relaxed">These Terms are intended by the parties as a final expression of their understanding and as a
