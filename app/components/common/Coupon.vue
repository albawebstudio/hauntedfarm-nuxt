...
<template>
  <div class="bg-gradient-to-br from-slate-900 to-slate-700 text-white text-center py-10 px-20 rounded-lg shadow-md relative">

<!--    <h3 class="text-2xl font-semibold mb-4">Save $2.00 off General Admission</h3>-->
    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white grow">Save $2.00 off General Admission</h3>
